...
export default function AnalysisPage() {
  ...
  const analysisState = location.state?.analysis;

  useEffect(() => {
    if (analysisState && analysisState.document_id === docId) {
      setClauses(analysisState.clauses || []);
      setRisks(analysisState.risks || []);
      setRecommendations(analysisState.recommendations || []);
      setLoading(false);
      return;
    }
    ...
    <div className="analysis-container">
      ...
      <div className="contract-viewer">
        ...
        <div className="contract-text">
          {clauses.length === 0 ? (
            <p className="muted">No clauses detected for this document. Try a contract with standard sections like termination or confidentiality.</p>
          ) : (
      ...
      <div>
        ...
        <ClauseDiffViewer docId={docId} initialRecommendations={recommendations} />
      </div>
      <div>
        <h2>AI Assistant</h2>
